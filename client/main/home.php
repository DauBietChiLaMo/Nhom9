...
<div class="container-fluid">
    <div class="text-center mb-5">
        <h4 class="section-title px-5"><span class="px-2">NEW PRODUCT</span></h4>
    </div>

    <div class="row px-xl-5 pb-3">
        <?php
        $sql = "SELECT * FROM product, category
        WHERE product.category_id=category.category_id AND product.status='1'
        ORDER BY product.product_id DESC LIMIT $begin,$p";
        ...
        ?>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <a style="text-decoration: none;" href="index.php?manage=product&id=<?php echo $row['product_id'] ?>">
